...
const WalrusIcon = ({ className, size = 24 }) => {
    return (
        <svg
        ...
        >
            ...
            <g transform="scale(0.6) translate(8, 8)">
                {/* Walrus head */}
                <path d="M12 4C7 4 3 8 3 13C3 18 7 20 12 20C17 20 21 18 21 13C21 8 17 4 12 4Z" fill="#7CFBFF" stroke="#000" strokeWidth="1" />
